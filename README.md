...
| [biol499script4a_v2_glmm_indices.R](./1_scripts/biol499script4a_v2_glmm_indices.R) | GLMM models for diversity indices |
| [biol499script4a_visualizations.R](./1_scripts/biol499script4a_visualizations.R) | Visualizing community patterns and model outputs |
| [biol499script4b_v2_multivariate.R](./1_scripts/biol499script4b_v2_multivariate.R) | Multivariate analysis (NMDS/PCA) |
...
### 📊 Data (`2_data_raw/`)
*Note: Raw data files are tracked locally. Contact the author for access to raw datasets.*
